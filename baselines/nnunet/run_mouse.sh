...
MODEL_PATH="/nvme2/mingzhi/NucCorr/TMI/OtherMethods/nnUNet/checkpoints_mouse/best_model.pth"

# 結果保存根目錄
RESULT_DIR="/nvme2/mingzhi/NucCorr/TMI/OtherMethods/nnUNet/results/mouse"
mkdir -p $RESULT_DIR
